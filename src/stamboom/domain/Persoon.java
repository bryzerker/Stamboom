...
public class Persoon {
    ...
    Persoon(int persNr, String[] vnamen, String anaam, String tvoegsel,
        ...
        alsOuderBetrokkenIn = Collections.emptyList();
    ...
    public String getInitialen() {
        ...
        {
            returnString += naam.substring(0,1);
            returnString += ".";
        }
        return returnString;
    }
    ...
    public String getNaam() {
        //todo opgave 1 gedaan
        String returnString = "";
        returnString += getInitialen() + " ";
        if(!tussenvoegsel.isEmpty())
        {
            returnString += tussenvoegsel + " ";
        }
        returnString += achternaam;
    ...
    public Gezin heeftOngehuwdGezinMet(Persoon andereOuder) {
        ...
        for(Gezin g: alsOuderBetrokkenIn)
        {
            if(this.equals(g.getOuder1())|| this.equals(g.getOuder2()))
            {
                if(g.isOngehuwd())
                {
                    return g;
